...
\begin{figure}[t!]
\centering
\includegraphics[width=6in]{figures/v4/figure_4} 
...
\begin{figure}[h!]
  \centering
  \vspace{-.5in}
  \includegraphics[width=6in]{figures/v4/figure6}
...
\begin{figure}[t!]
\centering%
\includegraphics[width=5in]{figures/v3/figure1_supp} 
...
% This elicits a strong response in some clusters of neurons, regardless
% of genetic background and developmental stage.  In npr1 worms, the
% elevated oxygen level will elicit a sustained period of activity, even
% in the lethargic stage, whereas N2 worms remain largely quiescent
% despite the increased oxygen concentration.
