...
% Goal: learn dynamical model of neural activity
% Challenge 1: how to capture nonlinear dynamics of neural activity with simple model? 
% Solution 1: recurrent state space models
% Challenge 2: how to combine information across trials?
% Solution 2: hierarchical model 
